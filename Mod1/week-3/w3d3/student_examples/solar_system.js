...
for (planet in system) {
    system[planet].momentum = (system[planet].velocity * system[planet].mass)
}
console.log(system.Jupiter.momentum - system.Pluto.momentum)

//Planet X

const planetX = {radiusp: 23432, name: 'Planet X', density: 1.75, tilt: 98.6, image: 'textures/planetX.gif', 
rotationperiod: 24, period: 90, radiuse: 34237, satellites: 4, au: 12.34, eccentricity: 0.632, velocity: 4.99, 
mass: 16.25, inclination: 0.85}
